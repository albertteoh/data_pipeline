...
, TestCase(
    ...
    input_table_name="MYTABLE",
    input_commit_statements=['', 'ALTER TABLE MYTABLE MODIFY DESCRIPTION VARCHAR2(400 CHAR) ', ''],
    input_record_types=[const.START_OF_BATCH, const.DATA, const.END_OF_BATCH],
    input_operation_codes=['', const.DDL, ''],
    input_primary_key_fields=None,
    input_record_counts=[0, 0, 1],
    input_commit_lsns=[0, 0, 0],
    expect_sql_execute_called=[None, "ALTER TABLE ctl.MYTABLE ALTER DESCRIPTION TYPE VARCHAR(400); -- lsn: 0, offset: 1", None],
    expect_execute_called_times=[0, 1, 1],
    expect_audit_db_execute_sql_called=[None, None, (UPDATE_SSP_SQL, ('CDCApply', 0, 'myprofile', 1, 'ctl', 'mytable'))],
    expect_commit_called_times=[0, 0, 1],
    expect_insert_row_count=[0, 0, 0],
    expect_update_row_count=[0, 0, 0],
    expect_delete_row_count=[0, 0, 0],
...
, TestCase(
    ...
    input_table_name="MYTABLE",
    input_commit_statements=['', 'ALTER TABLE MYTABLE ADD DESCRIPTION VARCHAR2(400 CHAR) ', ''],
    input_record_types=[const.START_OF_BATCH, const.DATA, const.END_OF_BATCH],
    input_operation_codes=['', const.DDL, ''],
    input_primary_key_fields=None,
    input_record_counts=[0, 0, 1],
    input_commit_lsns=[0, 0, 0],
    expect_sql_execute_called=[None, "ALTER TABLE ctl.MYTABLE ADD DESCRIPTION VARCHAR(400); -- lsn: 0, offset: 1", None],
    expect_execute_called_times=[0, 1, 1],
    expect_audit_db_execute_sql_called=[None, None, (UPDATE_SSP_SQL, ('CDCApply', 0, 'myprofile', 1, 'ctl', 'mytable'))],
    expect_commit_called_times=[0, 0, 1],
    expect_insert_row_count=[0, 0, 0],
