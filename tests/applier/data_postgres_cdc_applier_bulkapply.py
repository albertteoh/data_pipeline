...
, TestCase(
    ...
    expect_sql_execute_called=[
        None,
        None,
        "INSERT INTO ctl.IAG_MVDETAIL ( COMPANY, MVBODY, MVENGCAP, MVENGTYP, MVEQUIP, MVMAKE, MVMODEL, MVSERIES, MVTARE, MVYEAR, SEQUENCE, STDEQUIP ) VALUES\n  ( '1', 'COUPE', '35', 'FI', '(2 SEAT)', 'LOTUS', 'EVORA', NULL, '0', '2010', '124049', 'ABB ABS AC  AL  AW1 CLR EBD EDL IM  LSW PM  PS  PW  RCD RS  SPS TC  TCS' ) -- lsn: 0, offset: 1\n; -- lsn: 0, offset: 1",
    ],
...
, TestCase(
    ...
    expect_sql_execute_called=[
        None,
        None,
        "INSERT INTO ctl.CONNCT_CDC_PK5_COLS10 ( COL_NAS_9, COL_N_5, COL_N_6, COL_N_7, COL_N_8, COL_N_9, COL_TS_0, COL_V_1, COL_V_2, COL_V_3, COL_V_4, COMPNDPK_1, COMPNDPK_2, COMPNDPK_3, COMPNDPK_4, COMPNDPK_5 ) VALUES\n  ( 'This is a nasty string ??a??????????', '26.5', '26.6', '26.7', '26.8', '26.9', '2017-04-19 12:14:22', NULL, '26_varchar_2', '26_varchar_3', '26_varchar_4', '26', '26.1', '26.2', '26.3', '26.4' ) -- lsn: 0, offset: 1\n; -- lsn: 0, offset: 1",
    ],
...
, TestCase(
    ...
    expect_sql_execute_called=[
        ...
        None],
    expect_execute_called_times=[0, 0, 1, 1, 2, 2],
    ...
    expect_insert_row_count=[0, 0, 1, 1, 1, 1],
...
, TestCase(
    ...
    expect_sql_execute_called=[
        None,
        None,
        "INSERT INTO ctl.CONNCT_CDC_PK5_COLS10 ( COL_NAS_9, COMPNDPK_1 ) VALUES\n  ( 'string ''with quotes''', '26' ) -- lsn: 0, offset: 1\n; -- lsn: 0, offset: 1",
        None,
...
, TestCase(
    ...
    expect_sql_execute_called=[
        ...
        None,
        None,
        "INSERT INTO ctl.CONNCT_CDC_PK5_COLS10 ( COL_NAS_9, COL_N_5, COL_N_6, COL_N_7, COL_N_8, COL_N_9, COL_TS_0, COL_V_1, COL_V_2, COL_V_3, COL_V_4, COMPNDPK_1, COMPNDPK_2, COMPNDPK_3, COMPNDPK_4, COMPNDPK_5 ) VALUES\n  ( 'This is a nasty string ??a??????????', '26.5', '26.6', '26.7', '26.8', '26.9', '2017-04-19 12:14:22', '26_varchar_1', '26_varchar_2', '26_varchar_3', '26_varchar_4', '26', '26.1', '26.2', '26.3', '26.4' ) -- lsn: 0, offset: 1\n, ( 'This is a nasty string ??a??????????', '27.5', '27.6', '27.7', '27.8', '27.9', '2017-04-19 12:14:22', '27_varchar_1', '27_varchar_2', '27_varchar_3', '27_varchar_4', '27', '27.1', '27.2', '27.3', '27.4' ) -- lsn: 0, offset: 1\n; -- lsn: 0, offset: 1",
    ],
    expect_execute_called_times=[0, 0, 0, 1],
    ...
    expect_insert_row_count=[0, 0, 0, 2],
...
, TestCase(
    ...
    expect_sql_execute_called=[
        ...
        "UPDATE ctl.CONNCT_CDC_PK5_COLS10 SET COL_V_2 = '26.9' WHERE COMPNDPK_1 = '26'; -- lsn: 0, offset: 1",
        None],
    expect_execute_called_times=[0, 0, 0, 2, 2],
    ...
    expect_insert_row_count=[0, 0, 0, 2, 2],
...
, TestCase(
    ...
    expect_sql_execute_called=[
        ...
        "UPDATE ctl.CONNCT_CDC_PK5_COLS10 SET COL_V_2 = '26.9' WHERE COMPNDPK_1 = '26'; -- lsn: 0, offset: 1",
        None],
    expect_execute_called_times=[0, 0, 2, 2],
    expect_audit_db_execute_sql_called=[None, None, None, (UPDATE_SSP_SQL, ('CDCApply', 0, 'myprofile', 1, 'ctl', 'connct_cdc_pk5_cols10'))],
    expect_commit_called_times=[0, 0, 0, 1],
    expect_insert_row_count=[0, 0, 1, 1],
...
, TestCase(
    ...
    input_record_counts=[0, 0, 1],
    input_commit_lsns=[0, 0, 0],
    expect_sql_execute_called=[None, "CREATE TABLE ctl.CONNCT_CDC_PK5_COLS10 (SMALLINT0 SMALLINT, SMALLINT1 SMALLINT, SMALLINT2 NUMERIC(1, 1), SMALLINT3 NUMERIC(1, -1), INT0 INTEGER, INT1 INTEGER, INT2 NUMERIC(5, 2), INT3 NUMERIC(5, -2), BIGINT0 BIGINT, BIGINT1 BIGINT, BIGINT2 NUMERIC(10, 2), BIGINT3 NUMERIC(10, -2), NUMERIC0 NUMERIC(19), NUMERIC1 NUMERIC(19, 0), NUMERIC2 NUMERIC(19, -1), ctl_upd_ts TIMESTAMP, ctl_ins_ts TIMESTAMP); -- lsn: 0, offset: 1", None],
    expect_execute_called_times=[0, 1, 1],
    expect_audit_db_execute_sql_called=[None, None, (UPDATE_SSP_SQL, ('CDCApply', 0, 'myprofile', 1, 'ctl', 'connct_cdc_pk5_cols10'))],
    expect_commit_called_times=[0, 0, 1],
    expect_insert_row_count=[0, 0, 0],
...
, TestCase(
    ...
    input_record_counts=[0, 0, 1],
    input_commit_lsns=[0, 0, 0],
    expect_sql_execute_called=[None, """CREATE TABLE ctl.CONNCT_CDC_PK5_COLS10 (compndPk_1 NUMERIC(15, 5) NOT NULL, compndPk_2 NUMERIC(15, 5) NOT NULL, compndPk_3 NUMERIC(15, 5) NOT NULL, compndPk_4 NUMERIC(15, 5) NOT NULL, compndPk_5 NUMERIC(15, 5) NOT NULL, col_ts_0 TIMESTAMP(6), col_v_1 VARCHAR(25) NULL, col_v_2 VARCHAR(25) NULL, col_v_3 VARCHAR(25) NULL, col_v_4 VARCHAR(25) NULL, col_n_5 NUMERIC(15, 5) NULL, col_n_6 NUMERIC(15, 5) NULL, col_n_7 NUMERIC(15, 5) NULL, col_n_8 NUMERIC(15, 5) NULL, col_n_9 NUMERIC(15, 5) NULL, col_nas_9 VARCHAR(4000) NULL, CONSTRAINT cnst_CONNCT_CDC_PK5_COLS10 PRIMARY KEY( compndPk_1, compndPk_2, compndPk_3, compndPk_4, compndPk_5), ctl_upd_ts TIMESTAMP, ctl_ins_ts TIMESTAMP); -- lsn: 0, offset: 1""", None],
    expect_execute_called_times=[0, 1, 1],
    expect_audit_db_execute_sql_called=[None, None, (UPDATE_SSP_SQL, ('CDCApply', 0, 'myprofile', 1, 'ctl', 'connct_cdc_pk5_cols10'))],
    expect_commit_called_times=[0, 0, 1],
    expect_insert_row_count=[0, 0, 0],
...
, TestCase(
    ...
    input_record_counts=[0, 0, 1],
    input_commit_lsns=[0, 0, 0],
    expect_sql_execute_called=[None, "ALTER TABLE ctl.CONNCT_CDC_PK5_COLS10 ADD SMALLINT0 SMALLINT, ADD SMALLINT1 SMALLINT, ADD SMALLINT2 NUMERIC(1, 1), ADD SMALLINT3 NUMERIC(1, -1), ADD INT0 INTEGER, ADD INT1 INTEGER, ADD INT2 NUMERIC(5, 2), ADD INT3 NUMERIC(5, -2), ADD BIGINT0 BIGINT, ADD BIGINT1 BIGINT, ADD BIGINT2 NUMERIC(10, 2), ADD BIGINT3 NUMERIC(10, -2), ADD NUMERIC0 NUMERIC(19), ADD NUMERIC1 NUMERIC(19, 0), ALTER NUMERIC2 TYPE NUMERIC(19, -1); -- lsn: 0, offset: 1", None],
    expect_execute_called_times=[0, 1, 1],
    expect_audit_db_execute_sql_called=[None, None, (UPDATE_SSP_SQL, ('CDCApply', 0, 'myprofile', 1, 'ctl', 'connct_cdc_pk5_cols10'))],
    expect_commit_called_times=[0, 0, 1],
    expect_insert_row_count=[0, 0, 0],
